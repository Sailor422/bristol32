(kicad_sch (version 20231120) (generator "eeschema")
  ...
  (lib_symbols
    ...
    (symbol "Device:C" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      (property "Reference" "C" (at 0.762 1.524 0) (effects (font (size 1.27 1.27)) hide))
      (property "Value" "C" (at 0.762 -1.524 0) (effects (font (size 1.27 1.27))))
      (property "Footprint" "" (at 0 0 0) (effects (font (size 1.27 1.27)) hide))
      (pin "~" (at 0 3.81 270) (length 2.54) (name "~" (effects (font (size 1.27 1.27)))))
      (pin "~" (at 0 -3.81 90) (length 2.54) (name "~" (effects (font (size 1.27 1.27))))
    )
  )
  ...
  ; Sensor Section
  (symbol (lib_id "Device:R") (at 152.4 101.6 0) (unit 1)
    (in_bom yes) (on_board yes) (fields_autoplaced)
    (property "Reference" "U3" (at 154.432 101.6 90))
    (property "Value" "MMWAVE_SENSOR" (at 150.368 101.6 90))
    (property "Footprint" "" (at 152.4 101.6 0))
  )

  (symbol (lib_id "Device:R") (at 203.2 101.6 0) (unit 1)
    (in_bom yes) (on_board yes) (fields_autoplaced)
    (property "Reference" "U4" (at 205.232 101.6 90))
    (property "Value" "BME280_SENSOR" (at 201.168 101.6 90))
    (property "Footprint" "" (at 203.2 101.6 0))
  )

  (symbol (lib_id "Device:R") (at 152.4 127 0) (unit 1)
    (in_bom yes) (on_board yes) (fields_autoplaced)
    (property "Reference" "U5" (at 154.432 127 90))
    (property "Value" "SSD1306_OLED" (at 150.368 127 90))
